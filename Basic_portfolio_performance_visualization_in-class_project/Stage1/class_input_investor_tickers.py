...
# basic errous information input validation process
...
def main1():
    ...
    if (check1 and check2 and check3 and check4 and check5):
        ...
        data = []
        data.append(ticker_acquisition_date)
        data.append(ticker)
        data.append(ticker_quantity)
        data.append(ticker_unit_cost)
        data.append(ticker_cost_basis)
        data.append(ticker_start_of_year)
