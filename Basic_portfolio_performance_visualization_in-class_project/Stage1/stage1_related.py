...
from class_input_investor_tickers import main1

#-----------------------------------------------------------------------------
def investor_please_input():
    ...
    # add a column to show the rate of return based on the cost indicated in the investor information excel
    ...
    merged_portfolio_sp = pd.merge(merged_portfolio, sp_500_adj_close, left_on = 'datestamp', right_on = 'datestamp2')
