# --------------------------------------------------------------------------------
# This strategy is written on the platform of JoinQuant, so if anyone would like to see the backtesting performance, please visit: https://www.joinquant.com/
# Overall logic: When main board is doing well, catch the leading company instead of buying low!
# --------------------------------------------------------------------------------
